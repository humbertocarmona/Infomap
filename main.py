...
def main(teleportation_probability=0.15, y_shift=-0.08):
    """
    ...
    # print(f"flow2/flow1 = {n_flow[0]/n_flow[1]:0.2f}" )
    # edge_labels = dict()
    ...
    # ax.text(0.4, 0.4,f"$\\tau$={teleportation_probability}")
...
if __name__ == "__main__":
    G = main(teleportation_probability=0.)
